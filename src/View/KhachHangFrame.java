...
public class KhachHangFrame extends javax.swing.JFrame {
    ...
    public KhachHangFrame() {
        ...
        cardLayout = (CardLayout) (mainCardLayoutKH.getLayout());
        mainCardLayoutKH.add(KhachHangPanel, "khachHang");
        cardLayout.show(mainCardLayoutKH, "khachHang");
        mainCardLayoutKH.add(ThemKhachHangPanel, "themKhachHang");
        mainCardLayoutKH.add(SuaKhachHangPanel, "suaKhachHang");
    }
public void addSVG() {
    ...
    public void TraCuuKH() {
        ...
        String input = this.nhapTraCuujTextField.getText().toLowerCase();
    ...
    public void hienThongTinKH(){
        ...
        try {
            KhachHangModel kh = KhachHangDAO.getKHtheoMaKHK(maKHSua);

            // Sử dụng thông tin kh để cập nhật giao diện
            if (kh != null) {
                sua_hoTenjTextField.setText(kh.getTenKH());
                sua_CCCDjTextField.setText(kh.getCCCD());
                
                sua_gioiTinhjComboBox.setSelectedItem(kh.getGioiTinh());
                ...
                sua_diaChijTextField.setText(kh.getDiaChi());
                sua_SDTjTextField.setText(kh.getSDT());
    ...
    private void initComponents() {
        ...
        mainCardLayoutKH = new javax.swing.JPanel();
        ...
        nhapTraCuujTextField = new javax.swing.JTextField();
        traCuujButton = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        danhSachKHTable = new javax.swing.JTable();
        KH_suajButton = new javax.swing.JButton();
        KH_xoajButton = new javax.swing.JButton();
        KH_themjButton = new javax.swing.JButton();
        ThemKhachHangPanel = new javax.swing.JPanel();
        ...
        them_luujButton = new javax.swing.JButton();
        SuaKhachHangPanel = new javax.swing.JPanel();
        ...
        KhachHangLb.setForeground(new java.awt.Color(220, 220, 46));
        ...
        mainCardLayoutKH.setPreferredSize(new java.awt.Dimension(700, 600));
        mainCardLayoutKH.setLayout(new java.awt.CardLayout());

        KhachHangPanel.setBackground(new java.awt.Color(255, 255, 255));
        KhachHangPanel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        nhapTraCuujTextField.setBackground(new java.awt.Color(255, 255, 255));
        nhapTraCuujTextField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KH_suajButton.setBackground(new java.awt.Color(24, 24, 68));
        KH_suajButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        KH_suajButton.setForeground(new java.awt.Color(255, 255, 255));
        KH_suajButton.setText("Sửa");
        KH_suajButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KH_suajButtonActionPerformed(evt);
            }
        });

        KH_xoajButton.setBackground(new java.awt.Color(24, 24, 68));
        KH_xoajButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        KH_xoajButton.setForeground(new java.awt.Color(255, 255, 255));
        KH_xoajButton.setText("Xóa");
        KH_xoajButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KH_xoajButtonActionPerformed(evt);
            }
        });

        KH_themjButton.setBackground(new java.awt.Color(24, 24, 68));
        KH_themjButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        KH_themjButton.setForeground(new java.awt.Color(255, 255, 255));
        KH_themjButton.setText("Thêm");
        KH_themjButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KH_themjButtonActionPerformed(evt);
            }
        });
        ...
        KhachHangPanelLayout.setHorizontalGroup(
            ...
            .addGroup(KhachHangPanelLayout.createSequentialGroup()
                ...
                .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(KhachHangPanelLayout.createSequentialGroup()
                        .addComponent(KH_themjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(KH_xoajButton, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(KH_suajButton, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(KhachHangPanelLayout.createSequentialGroup()
                            .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(timTheoComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(TieudeTK, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGap(50, 50, 50)
                            .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(KhachHangPanelLayout.createSequentialGroup()
                                    .addComponent(nhapTraCuujTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(50, 50, 50)
        ...
        KhachHangPanelLayout.setVerticalGroup(
            ...
            .addGroup(KhachHangPanelLayout.createSequentialGroup()
                ...
                .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(KhachHangPanelLayout.createSequentialGroup()
                        .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(nhapTraCuujTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(27, 27, 27)
                .addGroup(KhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(KH_suajButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(KH_xoajButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(KH_themjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );

        mainCardLayoutKH.add(KhachHangPanel, "card2");

        ThemKhachHangPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabel3.setText("Nhập thông tin khách hàng cần thêm");
        ...
        them_luujButton.setBackground(new java.awt.Color(24, 24, 68));
        them_luujButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        them_luujButton.setForeground(new java.awt.Color(255, 255, 255));
        them_luujButton.setText("Thêm");
        them_luujButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                them_luujButtonActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout ThemKhachHangPanelLayout = new javax.swing.GroupLayout(ThemKhachHangPanel);
        ThemKhachHangPanel.setLayout(ThemKhachHangPanelLayout);
        ThemKhachHangPanelLayout.setHorizontalGroup(
            ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                .addGap(35, 35, 35)
                .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                        .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ThemKhachHangPanelLayout.createSequentialGroup()
                        .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                                    .addComponent(them_luujButton, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(them_huyjButton, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                                    .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(them_CCCDjTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                        .addComponent(them_diaChijTextField, javax.swing.GroupLayout.Alignment.LEADING))
                                    .addGap(32, 32, 32)
                                    .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(them_SDTjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        ThemKhachHangPanelLayout.setVerticalGroup(
            ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ThemKhachHangPanelLayout.createSequentialGroup()
                .addGap(35, 35, 35)
                .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                ...
                .addGroup(ThemKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(them_luujButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );

        mainCardLayoutKH.add(ThemKhachHangPanel, "card3");

        SuaKhachHangPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabel13.setText("Nhập thông tin cần sửa");
        ...
        javax.swing.GroupLayout SuaKhachHangPanelLayout = new javax.swing.GroupLayout(SuaKhachHangPanel);
        SuaKhachHangPanel.setLayout(SuaKhachHangPanelLayout);
        SuaKhachHangPanelLayout.setHorizontalGroup(
            SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                        .addGap(35, 35, 35)
                        .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                                .addComponent(jLabel12)
                                .addGap(35, 35, 35)
                                .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE))
                            .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                                .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(sua_ngaySinhjComboBox, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                                        .addComponent(ngaySinhjLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(sua_hoTenjTextField, javax.swing.GroupLayout.Alignment.LEADING))
                                    .addComponent(hoTenjLable, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(32, 32, 32)
                                .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(CCCDjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(sua_diaChijTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                                        .addComponent(diaChijLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(sua_CCCDjTextField)))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 31, Short.MAX_VALUE)
                        .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(gioiTinhjLabel)
                            .addComponent(sua_SDTjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(sdtjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(sua_gioiTinhjComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(31, Short.MAX_VALUE))
        );
        SuaKhachHangPanelLayout.setVerticalGroup(
            SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(SuaKhachHangPanelLayout.createSequentialGroup()
                .addGap(35, 35, 35)
                .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(50, 50, 50)
                .addGroup(SuaKhachHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(hoTenjLable)
                    .addComponent(gioiTinhjLabel)
        ...
        mainCardLayoutKH.add(SuaKhachHangPanel, "card4");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(mainCardLayoutKH, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void traCuujButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_traCuujButtonActionPerformed
        ...
        String input = this.nhapTraCuujTextField.getText();
    ...
    private void KH_suajButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KH_suajButtonActionPerformed
        ...
        try {
            if (selectedIndex == -1) {
                ...
                this.maKHSua = (Integer) maKHObject;
                cardLayout.show(mainCardLayoutKH, "suaKhachHang");
                hienThongTinKH();
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    }//GEN-LAST:event_KH_suajButtonActionPerformed

    private void KH_xoajButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KH_xoajButtonActionPerformed
        // TODO add your handling code here:
        ...
        try {
            if (removeIndex == -1) {
                ...
                if (choice == JOptionPane.OK_OPTION) {
                    // Xử lý xóa ở đây
                    // phải xóa tất cả hợp đồng của khách hàng đó mới xóa khách hàng được
                    int row = KhachHangDAO.XoaHopDongTheoMaKH(maKH);
                    if (1 > 0){
                        int row1 = KhachHangDAO.XoaKH(maKH);
                        if (row1 > 0) {
    ...
    }//GEN-LAST:event_KH_xoajButtonActionPerformed

    private void KH_themjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KH_themjButtonActionPerformed
        // TODO add your handling code here:
        cardLayout.show(mainCardLayoutKH, "themKhachHang");       
    }//GEN-LAST:event_KH_themjButtonActionPerformed
    ...
    private void them_luujButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them_luujButtonActionPerformed
    ...
    }//GEN-LAST:event_them_luujButtonActionPerformed
    ...
    private void sua_luujButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sua_luujButtonActionPerformed
        ...
        try {
            ...
            KhachHangModel khCu = KhachHangDAO.getKHtheoMaKHK(maKHSua);
            ...
            int choice = JOptionPane.showConfirmDialog(rootPane, "Bạn có chắc chắn muốn sửa không?", "Xác nhận xóa", JOptionPane.OK_CANCEL_OPTION);
            
            if (choice == JOptionPane.OK_OPTION) {
                    if (KhachHangDAO.CapNhatKH(maKHSua, khCu)) {
    ...
    private javax.swing.JButton KH_suajButton;
    private javax.swing.JButton KH_themjButton;
    private javax.swing.JButton KH_xoajButton;
    ...
    private javax.swing.JPanel SuaKhachHangPanel;
    private javax.swing.JPanel ThemKhachHangPanel;
    ...
    private javax.swing.JPanel mainCardLayoutKH;
    private javax.swing.JLabel ngaySinhjLabel;
    private javax.swing.JTextField nhapTraCuujTextField;
    ...
    private javax.swing.JButton them_luujButton;
